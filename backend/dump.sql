...
--
-- Data for Name: counter_values; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.counter_values (id, user_id, service_id, value) FROM stdin;
1	1	1	25
\.
...
COPY public.services (id, name, login, password) FROM stdin;
1	testname	testlogin	testpassword
\.
...
COPY public.users (id, token_id, name) FROM stdin;
1	testtoken	testname
\.
...
COPY public.users_services (id, user_id, service_id) FROM stdin;
1	1	1
\.
